...
namespace SABES.Services
{
    public class BillService : IBillService
    {
        ...
        public async Task<byte[]> ExportBillAsImageAsync(int billId)
        {
            ...
            {
                Color = SKColor.Parse("#3B82F6"), // Primary blue color
                TextSize = 42,
                IsAntialias = true,
                Typeface = SKTypeface.FromFamilyName("Arial", SKFontStyle.Bold)
            };

            canvas.DrawText("📊 InvoiceHub", margin + 20, margin + 50, sabesTitlePaint);
            ...
            canvas.DrawText("Business Management System", margin + 20, margin + 80, storeNamePaint);
            canvas.DrawText("Complete Business Solutions • Professional Service", margin + 20, margin + 105, taglinePaint);
            ...
            canvas.DrawText("Thank you for your business!", margin + 20, footerY, thankYouPaint);
            ...
            canvas.DrawText("Built with CodingZoo", margin + 20, footerY + 30, creditPaint);
        ...
        private int DrawPdfHeader(SKCanvas canvas, Bill bill, int pageWidth, int margin, int startY)
        {
            ...
            // Company name and details (no logo)
            ...
            canvas.DrawText("InvoiceHub", margin + 20, currentY + 35, companyNamePaint);
            ...
            canvas.DrawText("Business Management System", margin + 20, currentY + 50, companySubPaint);
            canvas.DrawText("Complete Business Solutions • Professional Service", margin + 20, currentY + 65, companySubPaint);
        ...
        private void DrawPdfFooter(SKCanvas canvas, Bill bill, int pageWidth, int pageHeight, int margin)
        {
            ...
            canvas.DrawText("Built with CodingZoo", margin + 20, footerY, creditPaint);
